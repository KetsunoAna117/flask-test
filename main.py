...
def update_stock_prices():
    ...
    # Emit random news
    random_news_item = get_random_news(connection_pool)
    print("Random News Item:", random_news_item)
    ...
    with app.app_context():
        ...
        socketio.emit('random_news', random_news_item)  # Emit a random news item
